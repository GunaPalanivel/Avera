...
def test_submission_regression():
    ...
    # Adobe candidate (narrative-fit recovery via skill synonyms/adjacencies)
    if "CAND_0005538" in target_ids:
        assert "CAND_0005538" in top_100_ids, "Adobe candidate CAND_0005538 must be in top 100"
