...
def get_base_candidate() -> dict:
    return {
        ...
        "profile": {
            ...
            "current_title": "Senior AI Engineer", "current_company": "Product Corp",
            "current_company_size": "100-500", "current_industry": "Tech"
        },
        "career_history": [
            {
                "company": "Product Corp", "title": "Senior AI Engineer",
                "start_date": "2022-01-01", "duration_months": 24, "is_current": True,
                "industry": "Tech", "company_size": "100-500", "description": "Test"
            },
            {
                "company": "Other Corp", "title": "AI Engineer",
                "start_date": "2020-01-01", "duration_months": 24, "is_current": False,
                "industry": "Tech", "company_size": "100-500", "description": "Test"
            }
        ],
        "skills": [
        ...
        "redrob_signals": {
            "profile_completeness_score": 100, "signup_date": "2020-01-01", "last_active_date": "2026-06-01",
            "open_to_work_flag": True, "profile_views_received_30d": 10,
            "applications_submitted_30d": 1, "recruiter_response_rate": 0.8,
            "avg_response_time_hours": 1.0, "connection_count": 500,
            ...
            "search_appearance_30d": 10, "saved_by_recruiters_30d": 5,
