...
The Avera ranking engine implements a hybrid semantic + deterministic scoring system. Weights and logic are derived from the bundled Track 1 job description ([`DataSet/job_description.txt`](../../DataSet/job_description.txt)).
...
3. **Construct sentence**: e.g., _"Strong fit: Lead AI Engineer at Razorpay with 6.7 YOE. Demonstrates deep expertise in Embeddings and Python."_
