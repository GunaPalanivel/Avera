...
- **Negative:** We lose the ability to perform fuzzy semantic matching on unstructured text blocks without explicitly coding heuristic parsers (e.g., regex for "NDCG" or "RAG" in summaries).
